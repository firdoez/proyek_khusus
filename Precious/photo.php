...
<body>
    <p class="section-title"><span class="title custom">Pricelist Photo</span><span class="desc">Beberapa paket pricelist photo yang kami sediakan</span></p>
			<div class="col">
...
<?php
$hasil = mysql_query("SELECT * FROM photo order by id desc");
...
?>
  ...
  <tr>
    ...
    <a href="?p=editphoto&do=update&id=<?php echo $id; ?>"> | edit</a><a href="?p=photo&do=delete&id=<?php echo $id; ?>"> | delete</a> <?php } ?> </h5>   </td>
  </tr>
  <tr>
  <td><p>Fasilitas : </p>
    <p><?php echo $isi; ?></p>
...
if ($sql){
echo "<script>
alert('DELETE paket photo sukses');
window.location='index.php?p=photo';
</script>";
}else{
echo "<script>
alert('DELETE paket photo gagal');
window.location='index.php?p=photo';
</script>"; 
	}
	}
