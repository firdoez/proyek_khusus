...
<body>
			...
			<p class="section-title"><span class="title custom">Edit Harga Photo</span><span class="desc">Edit data paket foto</span></p>	
	
<!-- left-content -->
	<div class="contact-left">
		<h5 class="custom">EDIT HARGA PHOTO</h5>
       <?php
if($_SESSION['login']){
...
window.location='index.php?p=photo';
		...
		if($_GET['do'] == "update"){
			include "konek.php";
	$sql = mysql_query("SELECT * FROM photo WHERE id='$_GET[id]'") ;
	$ambil = mysql_fetch_array($sql);
	
	?>
		<!-- form -->
		<form id="formMail" action="?p=editphoto" method="post">
			<fieldset>
				<p>
