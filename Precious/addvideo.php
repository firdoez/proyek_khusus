...
<body>
			...
			<p class="section-title"><span class="title custom">Harga Video</span><span class="desc">Tambahkan data paket video yang baru</span></p>	
	
<!-- left-content -->
	<div class="contact-left">
		<h5 class="custom">TAMBAHKAN HARGA VIDEO BARU</h5>
        <?php
...
if($_REQUEST['ngepost']=='1'){
	//kondisi jika kode benar
		...
		$hasil=mysql_query("INSERT into video (judul, isi, harga) values ('$judul','$isi','$harga')");
		//kondisi jika insert data sukses dan gagal
		if ($hasil){
			echo "<script>
			alert('Anda telah menambahkan harga video.');
			window.location='index.php?p=addvideo';
			</script>";
		}else{
			echo "<script>
...
?>
		<!-- form -->
		<form id="formMail" action="?p=addvideo" method="post">
			<fieldset>
				<p>
