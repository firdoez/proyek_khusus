...
<body>
    <p class="section-title"><span class="title custom">Buku Tamu</span><span class="desc">Beberapa komentar dari pengunjung website</span></p>
			<div class="col">
...
<?php
$hasil = mysql_query("SELECT * FROM contact order by id desc");
...
?>
  ...
  <tr>
    ...
    <a href="?p=seecontact&do=delete&id=<?php echo $id; ?>">| delete</a> <?php } ?> </h5>   </td>
  </tr>
  <tr>
  <td><p>Email : </p>
    <p><?php echo $email; ?></p>
...
if ($sql){
echo "<script>
alert('DELETE bukutamu sukses');
window.location='index.php?p=seecontact';
</script>";
}else{
echo "<script>
alert('DELETE bukutamu gagal');
window.location='index.php?p=seecontact';
</script>"; 
	}
	}
